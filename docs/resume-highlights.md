# Resume & LinkedIn Highlights — Praisel Ekpenyong

Copy sections below into resume, LinkedIn About, or application cover letters.
...
Each bullet includes **what** (2–3 skills/tools), **how**, **where** (queue, console, segment, tenant), and a plain **why** — written as one normal sentence.

*Example breakdown:* “Triaged process alerts with **Wazuh** and **Sysmon** on the **Windows endpoint fleet**, catching suspicious downloads early so the team could act on the right host before damage spread.”
...
## LinkedIn Featured Section (suggested)
