const INCIDENTS = {
  "inc-001": {
    ...
    html: `
      <section><h4>Summary</h4><p>P2 true positive. Unauthorized BITS download on WKSTN-042 triggered Wazuh 180001 and Defender. Contained in 13 minutes. Caldera profile: T1-Windows-Download-Exec.</p></section>
...
User: CORP\\jsmith</pre></section>
  ...
  "inc-002": {
    ...
    html: `
      <section><h4>Summary</h4><p>Unauthorized user caldera_svc and malicious crontab on SRV-LNX-01. Detected via Wazuh 5902/2832 within 3 minutes of Caldera ability execution.</p></section>
  ...
  "inc-003": {
    ...
    html: `
      <section><h4>Summary</h4><p>tshark PCAP capture and RDP registry port change on finance workstation WKSTN-099. IR engaged per policy.</p></section>
  ...
  "inc-004": {
    ...
    html: `
      <section><h4>Summary</h4><p>47 failed VPN logins from external scanner after geo-block change CHG-8821. No valid AD users. Closed as P5 false positive.</p></section>
  ...
  "inc-005": {
    ...
    html: `
      <section><h4>Summary</h4><p>User-reported phish with SPF/DKIM/DMARC failures. Correlated with PowerShell cradle and Caldera T1-Phish-to-Host on WKSTN-042.</p></section>
